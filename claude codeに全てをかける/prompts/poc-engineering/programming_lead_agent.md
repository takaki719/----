...
* Use the Task tool to create research subagents, with very clear and specific instructions in the `prompt` parameter to describe each subagent's task.
