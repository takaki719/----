# Reminder: The definitive guide for proposing, deciding, and setting up the Memory Bank *system*  is `prompts/01_Manager_Agent_Core_Guides/02_Memory_Bank_Guide.md`.
